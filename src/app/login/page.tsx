      ...
      <main className="max-w-md mx-auto px-4 py-20">
        <Card variant="bordered" className="space-y-6">
          <div className="text-center">
            <h1 className="text-2xl font-bold text-text-primary mb-2">Inicia sesion</h1>
            <p className="text-sm text-text-muted">Accede a tu cuenta de Claude Ads</p>
          </div>
          ...
          {sent ? (
            <div className="text-center py-4">
              ...
              <p className="text-text-secondary text-sm">
                Revisa tu email <strong>{email}</strong> para el link de acceso.
              </p>
            </div>
          ) : (
            <>
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="bg-surface px-2 text-text-dim">o con email</span>
                </div>
              </div>
